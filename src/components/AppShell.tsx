...
export function AppShell() {
  ...
  return (
    <div className="flex min-h-screen w-full text-foreground" style={{ background: "#fafaf9" }}>
      ...
      {/* Main */}
      <div className="flex min-w-0 flex-1 flex-col bg-background md:mt-3 md:rounded-tl-2xl md:border-l md:border-t md:border-[#f0f0ee] md:shadow-[0_-1px_0_rgba(0,0,0,0.02)]">
        <header className="sticky top-0 z-30 flex h-16 items-center gap-3 border-b bg-white/95 px-4 backdrop-blur-md md:px-6 md:rounded-tl-2xl shadow-sm">
